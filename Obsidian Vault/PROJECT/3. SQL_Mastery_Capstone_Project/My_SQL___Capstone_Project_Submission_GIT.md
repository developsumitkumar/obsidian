...
This ER diagram maps `Hospital_Records`' 13 tables and their PK/FK relationships, using standard entity-box notation with cardinality labels (1:M). It highlights `Doctor_Department` and `Prescription` as junction tables resolving many-to-many relationships, and flags `Payment.patient_id` as a joinable but _undeclared_ foreign key — a genuine referential-integrity gap in the schema.
   ...
   ROUGH
![Pasted image 20260914063310.png](attachments/Pasted%20image%2020260914063310.png)


 FINAL
![Hospital_Records_ERD 1.png](attachments/Hospital_Records_ERD%201.png)


2. Zomato Table (Technically NO ER Diagram)
   
   ![Pasted image 20260914064033.png](attachments/Pasted%20image%2020260914064033.png)
...
ORDER BY z.email;
```
<img src="attachments/Pasted%20image%2020260914064915.png" width="700" alt="Pasted image 20260914064915.png">
...
![Pasted image 20260914065300.png](attachments/Pasted%20image%2020260914065300.png)
...
FROM payment;
```
![Pasted image 20260914081035.png](attachments/Pasted%20image%2020260914081035.png)
...
![Pasted image 20260914081144.png](attachments/Pasted%20image%2020260914081144.png)
...
### Postgre SQL
![Pasted image 20260914083437.png](attachments/Pasted%20image%2020260914083437.png)
```sql
SELECT city,
...
### SQL
![Pasted image 20260914084030.png](attachments/Pasted%20image%2020260914084030.png)
```sql
SELECT city,
    COUNT(*) AS total_customers,
...
![Pasted image 20260914084320.png](attachments/Pasted%20image%2020260914084320.png)
```sql
...
![Pasted image 20260914090448.png](attachments/Pasted%20image%2020260914090448.png)
...
![Pasted image 20260914090805.png](attachments/Pasted%20image%2020260914090805.png)
...
![Pasted image 20260914092617.png](attachments/Pasted%20image%2020260914092617.png)
```sql
...
![Pasted image 20260914092703.png](attachments/Pasted%20image%2020260914092703.png)
...
PostgreSQL
![Pasted image 20260914122220.png](attachments/Pasted%20image%2020260914122220.png)
```sql
WITH city_avg AS (
...
MySql(Workbench)
![Pasted image 20260914122321.png](attachments/Pasted%20image%2020260914122321.png)
```sql
WITH city_avg AS (
    SELECT city, AVG(total_spent) AS avg_spend
    FROM zomato_customers_india
...
1. The 3-table join
![Pasted image 20260914124456.png](attachments/Pasted%20image%2020260914124456.png)
```SQL
...
```
 ...
 ![Pasted image 20260914124653.png](attachments/Pasted%20image%2020260914124653.png)
 ```sql
...
![Pasted image 20260914124801.png](attachments/Pasted%20image%2020260914124801.png)
 ```sql
...
![Pasted image 20260914124856.png](attachments/Pasted%20image%2020260914124856.png)
```sql
...
![Pasted image 20260914124957.png](attachments/Pasted%20image%2020260914124957.png)
```sql
...
<img src="attachments/Hospital_Billing_ERD_from_paragraph.png" width="700" alt="Hospital_Billing_ERD_from_paragraph.png">
...
```
![Pasted image 20260914160202.png](attachments/Pasted%20image%2020260914160202.png)
...
```
![Pasted image 20260914160134.png](attachments/Pasted%20image%2020260914160134.png)
...
![Pasted image 20260914160452.png](attachments/Pasted%20image%2020260914160452.png)
...
```
![Pasted image 20260914160810.png](attachments/Pasted%20image%2020260914160810.png)
...
![Pasted image 20260914161129.png](attachments/Pasted%20image%2020260914161129.png)
...
```
![Pasted image 20260914165737.png](attachments/Pasted%20image%2020260914165737.png)